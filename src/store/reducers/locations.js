...
export const fetchlocations = createAsyncThunk('locations/fetchlocations', async () => {
    ...
    const response = await fetch(url + '/Location/GetAllLocation', params);
...
export const addlocations = createAsyncThunk('locations/addlocations', async (body) => {
    ...
    const response = await fetch(url + '/Location/AddLocation', params);
...
export const editlocations = createAsyncThunk('locations/editlocations', async (body) => {
    ...
    const response = await fetch(url + '/Location/UpdateLocation/' + body.id, params);
