...
import { addlocalities } from 'store/reducers/localities';
        ...
        <>
            ...
            <Formik
                ...
                onSubmit={async (values, { setErrors, setStatus, setSubmitting, resetForm }) => {
                    try {
                        setSubmitting(true);
                        var t = await dispatch(addlocalities(values));

                        setStatus({ success: false });
                        setSubmitting(false);

                        if (t.type == 'localities/addlocalities/fulfilled') {
                            resetForm();
                            close();
                            await dispatch(fetchlocalities());
                        }

                        if (t.type == 'localities/addlocalities/rejected') {
