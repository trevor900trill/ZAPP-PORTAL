...
const RegionsTable = ({ rows, modalOpen }) => {
    ...
    function createData(regionName, regionCode, id) {
        return { regionName, regionCode, id };
    }

    const datarows = rows.map((element) => createData(element.regionName, element.regionCode, element.id));
