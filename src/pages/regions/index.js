...
import AddRegions from './dialogs/AddRegions';
import EditRegions from './dialogs/EditRegions';
// assets
...
const RegionsPage = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            var t = await dispatch(fetchregions());
            if (t.type == 'regions/fetchregions/rejected') {
                console.log(t);
    ...
    return (
        <Grid container rowSpacing={4.5} columnSpacing={2.75}>
            ...
            >
                <DialogContent>
                    <EditRegions close={handleEditClose} initialDialogValues={initialDialogValues} />
                </DialogContent>
            </Dialog>
            ...
            <Grid item xs={12} md={12} lg={12}>
                ...
                <MainCard sx={{ mt: 2 }} content={false}>
                    <RegionsTable rows={regions.regionsReponse} modalOpen={handleClickEdit} />
                </MainCard>
            </Grid>
        </Grid>
    );
